<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="details.aspx.cs" Inherits="Project.NET.details" %>
    ...
    <style type="text/css">
        body {
            font-family: Arial, sans-serif;
             background:linear-gradient(45deg, #18881b, transparent);
            ...
            <table cellpadding="3" cellspacing="3" class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" CssClass="RequiredFieldValidator" runat="server" ControlToValidate="PhoneText" Display="Dynamic" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" CssClass="RequiredFieldValidator" runat="server" ControlToValidate="PhoneText" Display="Dynamic" ErrorMessage="Enter Valid Phone No. " ForeColor="Red" ValidationExpression="^[6-9]\d{9}$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
